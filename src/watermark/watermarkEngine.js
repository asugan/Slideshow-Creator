...
} = require('./adaptiveDetector');
const {
    detectWatermarkConfig,
    calculateWatermarkPosition,
    resolveInitialStandardConfig
} = require('./watermarkConfig');
...
class WatermarkEngine {
    ...
    async removeWatermarkFromImage(image, options = {}) {
        ...
        ctx.putImageData(
            new (require('canvas').ImageData)(finalImageData.data, finalImageData.width, finalImageData.height),
            0,
            0
        );
...
module.exports = { WatermarkEngine, detectWatermarkConfig, calculateWatermarkPosition };
